...
export const pesachSeder: Section = {
  ...
  pieces: [
    ...
    },
    {
      ...
      name: 'Adir Hu',
      author: 'Trad.',
      youtubeUrl: 'https://youtu.be/9BGTGDuUFVI',
    ...
    },
    {
      id: '556c',
      name: 'Chad Gadya',
      author: 'Yitchak Piroznikov',
      youtubeUrl: 'https://youtu.be/nm0dVQZzcy8',
      description: `This melody appears originally in Yitzchak Piroznikov's Haggadah, and was later included by Idelsohn in his Liederbuch, where it is attributed to Piroznikov. It also appears in an untitled manuscript of songs in Abraham Bernstein's collection, similarly attributed to Piroznikov. The lyrics in all of these publications are in modern Hebrew, but it appears with the "original" Aramaic words of Chad Gadya in Shlomo Ravitz's Kol Yisrael (without any attribution).`
    }
  ]
}
