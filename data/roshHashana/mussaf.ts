...
export const rhMussaf: Section = {
  id: 'rhMussaf',
  name: 'Rosh Hashana Mussaf',
  shortName: 'Mussaf',
  hebrewName: 'מוסף',
  pieces: [
    {
    ...
    },
    {
      ...
      youtubeUrl: 'https://youtu.be/W2TIxBSotQU',
      description: `Zochreinu Lachayim is the first of the four insertions to the Amida specifically for the period of Rosh Hashana to Yom Kippur. It is a succinct poem of only four lines, which each end with the word "life", and asks God to inscribe us in the Book of Life for the coming year.\n
        This plaintive tune, composed by Haim Wasserzug in the late 19th century is considered the traditional melody in Nusach Anglia. `
    },
    {
      id: '240c',
      name: "Melech Elyon",
    ...
    },
    {
      ...
      name: "Ochila La'el",
      author: 'Hillel Paley',
      youtubeUrl: 'https://youtu.be/nOEOupnhH0A',
      description: `Ochila La'el is a personal prayer which the chazzan reads during the Rosh Hashana and Yom Kippur Mussaf, beseeching God to support him in conveying the following prayers. It was probably composed in the period of the Amoraim and is based on several verses from Tanach (notably Proverbs 16).\n
