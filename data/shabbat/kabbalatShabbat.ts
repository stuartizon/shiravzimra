...
export const kabbalatShabbat: Section = {
  id: 'kabbalatShabbat',
  name: 'Kabbalat Shabbat',
  shortName: 'Kabbalat Shabbat',
  hebrewName: 'קבלת שבת',
  pieces: [
    {
      id: '1b',
    ...
    },
    {
      ...
      youtubeUrl: 'https://youtu.be/HeqbTDlKfGY',
